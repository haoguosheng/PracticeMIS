...
//h    public static String currentGradeNum = "";
    ...
    public static final String teacherTable="teacherinfo",studentTable="student",tableName="tableName";
    ...
    public static final String loginURL = "/StudentTrainning-war";
    public static final int dayAfterDisabled = 15;
    public static final String saveImgTeachPath = "D:/uploadedFiles/TeachFiles";
    public static final String saveImgStuPath = "D:/uploadedFiles/StuFiles";
    public static final String sessionTeacher="teacherUser",sessionStudent="studentUser";
    public static final String defaultPassword="111111";
    public static final String userNoLength="userNoLength";
}
